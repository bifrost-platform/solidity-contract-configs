...
SUPPORTING_TEST_CHAINS = [Chain.BFC_TEST, Chain.ETH_GOERLI, Chain.BNB_TEST, Chain.MATIC_MUMBAI, Chain.BASE_GOERLI]
...
ASSET_ON_BFC_TEST = [
    ...
    Asset.BRIDGED_BASE_GOERLI_ETH_ON_BFC_TEST,
    ...
    # EGG
    Asset.BRIDGED_ETH_GOERLI_EGG_ON_BFC_TEST,
    Asset.UNIFIED_EGG_ON_BFC_TEST,

    # DAI
    Asset.BRIDGED_BASE_GOERLI_DAI_ON_BFC_TEST,
    Asset.UNIFIED_DAI_ON_BFC_TEST
...
ASSET_ON_BASE_GOERLI = [
    Asset.ETH_ON_BASE_GOERLI,
    Asset.DAI_ON_BASE_GOERLI
]

SUPPORTING_ASSETS = ASSET_ON_BFC_TEST + ASSET_ON_ETH_GOERLI + ASSET_ON_BNB_TEST + ASSET_ON_MATIC_MUMBAI + ASSET_ON_BASE_GOERLI
